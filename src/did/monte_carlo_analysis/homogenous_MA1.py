...
import pandas as pd
import os
from did.monte_carlo_analysis.synthetic_data_gen import _generate_homogenous_ma1_data
...
def monte_carlo_homogenous_MA1_ols(data_info):
    """
    Perform Monte Carlo simulations for a homogenous MA(1) model with placebo treatment assignment.
    ...
    data_info : dict
        ...
        - 'T' : int
            ...
            than 1.
        - 'theta' : float
            The MA(1) moving average shock parameter, specifying the persistence of the process. 
    ...
    Notes:
    ------
    - This function generates synthetic panel data using a homogenous MA(1) model, assigns placebo 
    ...
    Example:
    --------
    To perform Monte Carlo simulations with 5 states, 10 time periods, a theta of 0.5, and 100 
    ...
    >>> results = monte_carlo_homogenous_MA1_ols(data_dict)
...
def monte_carlo_homogenous_MA1_crse(data_info):
    """
    Perform Monte Carlo simulations for a homogenous MA(1) model with placebo treatment assignment.
    This function performs Monte Carlo simulations on the generated treated data to understand the 
    ...
    data_info : dict
        ...
        - 'T' : int
            ...
            than 1.
        - 'theta' : float
            The MA(1) moving average parameter, specifying the persistence of the process. 
            Must be in the range [0, 1].
        - 'num_individuals' : int
    ...
    >>> results = monte_carlo_homogenous_MA1_crse(data_dict)
...
def monte_carlo_homogenous_MA1_res_agg(data_info):
    """
    Perform Monte Carlo simulations for a homogenous MA(1) model with placebo treatment assignment.
    This function performs Monte Carlo simulations on the generated treated data to understand the 
    ...
    data_info : dict
        ...
        - 'T' : int
            ...
            than 1.
        - 'theta' : float
            The MA(1) moving average parameter, specifying the persistence of the process. Must be 
            in the range [0, 1].
        - 'num_individuals' : int
            The number of individuals or entities within each state or group. Must be a positive 
            integer.
    ...
    >>> results = monte_carlo_homogenous_MA1_res_agg(data_dict)
...
def monte_carlo_homogenous_MA1_wbtest(data_info):
    """
    Perform Monte Carlo simulations for a homogenous MA(1) model with placebo treatment assignment.
    This function performs Monte Carlo simulations on the generated treated data to understand the 
    ...
    Example:
    --------
    To perform Monte Carlo simulations with 5 states, 10 time periods, a theta of 0.5, and 
    100 individuals per state, you can call the function as follows:
        data_dict = {
            'N': 5,
            'T': 10,
            'theta': 0.5,
    ...
    >>> results = monte_carlo_homogenous_MA1_wbtest(data_dict)
    ...
    results_df = _calculate_statistics(num_simulations= num_simulations ,
                                       ...
                                       beta1_estimates= beta1_estimates, bias_values= bias_values, 
                                       reject_count_1= reject_count_1,reject_count_power= 
                                       reject_count_power, standard_error_values= standard_error_values)
...
def monte_carlo_homogenous_MA1_fgls(data_info):
    """
    Perform Monte Carlo simulations for a homogenous MA(1) model with placebo treatment assignment.
    This function performs Monte Carlo simulations on the generated treated data to understand the 
    ...
    >>> results = monte_carlo_homogenous_MA1_fgls(data_dict)
